...
// 启用固定的 PWM 输出进行调试
// 0 = 禁用 (PID 正常运行)
// 1 = 启用 (S5, S6, S7 将被覆盖为固定值,测试模式跳过 ADC 读取)
...
// PID 环路定时器 (1,000,000 / 8000 = 125µs)
// #define PID_LOOP_PERIOD_US 125
// 1kHz (1000µs) 环路
#define PID_LOOP_PERIOD_US 1000
// PID 输出限制。舵机速度范围为 1000-1450 (反) 和 1550-2000 (正).
...
// 舵机死区 (1449-1548). 
// 这是用于“跳跃”的值 (补偿)
// 实测死区范围：1449-1548(临界不稳定，第一次测的时候是不含)；
// ≤1448-1449顶视顺时针转：≥1548-1550顶视逆时针转
#define PID_VELOCITY_DEADZONE 50
